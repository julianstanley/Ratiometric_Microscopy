...
plot(gfp1_deltas ~ gfp1_prop$data$lambda, type = 'l', col = 'black', main = "Lambda profile of roGFP1", xlab = expression(lambda), ylab = expression(delta), bty = 'L')

gfp2_deltas <- gfp2_prop$data$ox/gfp2_prop$data$red
plot(gfp2_deltas ~ gfp2_prop$data$lambda, type = 'l', col = 'black', main = "Lambda profile of roGFP2", xlab = expression(lambda), ylab = expression(delta), bty = 'L')
