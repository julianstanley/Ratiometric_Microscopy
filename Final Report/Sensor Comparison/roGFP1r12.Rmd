...
emission_ox <- seq(401, 500, by = 1)
emission_red <- seq(1, 100, by = 1)
emission_25ox <- seq(101, 200, by = 1)
emission_50ox <- seq(201, 300, by = 1)
emission_75ox <- seq(301, 400, by = 1)

concentration <- seq(1, 100, by = 1)

plot(emission_ox ~ concentration, main = "Emission is a function of concentration", xlab = "roGFP concentration (relative)", ylab = "Emission readout (relative)", type = 'l', xlim = c(1, 100), ylim = c(1, 1000), col = colors[5], lwd = 3)
...
plot(rep(5, 100) ~ concentration, main = "Ratiometric outputs are independent \n of concentration", xlab = "roGFP concentration (relative)", ylab = "R (relative)", type = 'l', xlim = c(1, 100), ylim = c(1,10), col = colors[5], lwd = 3)
points(rep(2, 100) ~ concentration, type = 'l', col = colors[2], lwd = 3)
points(rep(3, 100 ) ~ concentration, type = 'l', col = colors[3], lwd = 3)
points(rep(4, 100)~ concentration, type = 'l', col = colors[4], lwd = 3)
points(rep(1, 100) ~ concentration, type = 'l', col = colors[1], lwd = 3)
