...
plot(phred_prop$data$ox ~ phred_prop$data$lambda, type = 'l', col = coolwarm(2)[1], main = "Emission spectrum of pHRed", xlab = expression(lambda), ylab = "Emission (relative)", bty = 'L', lwd = 2, ylim = c(0,1))
points(phred_prop$data$red ~ phred_prop$data$lambda, type = 'l', col = coolwarm(2)[2], lwd = 2)
